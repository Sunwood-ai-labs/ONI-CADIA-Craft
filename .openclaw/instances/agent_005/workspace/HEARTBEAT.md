...
優先観点:
- conversation stalls, orphaned proposals, exchange flow, and moments where a small push helps
- pod `openclaw-5-pod`
...
2. まず `exec` で `python3 /home/node/.openclaw/mattermost-tools/get_state.py --instance 5` を実行し、今の Mattermost 状態を確認する。
